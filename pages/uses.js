        ...
        <article className='px-2 text-base'>
          ...
          <div className='text-lg text-gray-600'>
            <p className='text-lg font-normal'>
              Sometimes people asking me about the specifics of some piece of
              software or hardware I use. I summarized my uses lists here.
            </p>
            ...
            <div className='w-full py-4'>
              ...
              <ul className=' pl-4 list-disc ml-5'>
                <li>
                  Code Editor{' ~ '}
                  <ExtLink href='https://code.visualstudio.com'>
                    VS Code
                  </ExtLink>
                </li>
                ...
                <li>
                  Code Editör Font{' ~ '}
                  <ExtLink href='https://github.com/tonsky/FiraCode'>
                    Fira Code
                  </ExtLink>
                </li>
                <li>
                ...
                <li>
                  Console{' ~ '}
                  <ExtLink href='https://gnunn1.github.io/tilix-web/'>
                    Tilix
                  </ExtLink>
                </li>
              </ul>
              ...
              <ul className='text-light-secondary pl-4 list-disc ml-5'>
                <li>
                  Operating System{' ~ '}
                  <ExtLink href='https://pop.system76.com/'>POP OS</ExtLink>
                </li>
                <li>
                  Primary Browser{' ~ '}
                  <ExtLink href='https://vivaldi.com/'>Vivaldi</ExtLink>
                </li>
                <li>
                  Secondary Browser {' ~ '}
                ...
                <li>
                  ...
                  <ExtLink href='https://trello.com'>Trello</ExtLink>
                </li>
              </ul>
              ...
              <ul className='text-light-secondary pl-4 list-disc ml-5'>
                <li>
                  Markdown Editor{' ~ '}
                  <ExtLink href='https://ia.net/writer'>iA Writer</ExtLink>
                </li>
                <li>
                  Task & Project Managment{' ~ '}
                  <ExtLink href='https://trello.com'>Trello App</ExtLink>
                </li>
              </ul>
            </div>
          </div>
