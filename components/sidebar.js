...
export default function sidebar() {
    ...
    <div className="bg-gray-100 rounded mt-10 w-11/12 mx-auto text-center py-5 px-3 text-gray-700">
                        ...
                        <p className="text-sm font-light my-3">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                            Voluptate praesentium nisi nesciunt dolorem aperiam dolor excepturi, provident ea atque
                            accusantium dicta harum natus cumque vitae nulla quo distinctio sunt! Harum.</p>
