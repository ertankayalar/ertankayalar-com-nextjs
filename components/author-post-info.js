    ...
    return (
        ...
        <div className="post-author flex flex-wrap  bg-gray-200 py-6 px-4 rounded-lg items-center">
                        <div className="w-full  md:w-1/5">
                            <img className="rounded-full mx-auto w-24 md:w-32" src="/assets/author.jpg" alt="" />
                        </div>
                        <div className="w-full md:w-4/5 py-3 px-2">

                            <Link href="#">
                            <a className="font-semibold text-2xl text-gray-800 hover:text-indigo-700" >Ertan Kayalar</a>

                            </Link>
                            <p className="text-gray-600 text-md font-light">Web Developer</p>
                            <p className="text-gray-700">Ertan 30 yıldır kod yazıyor. En çok ilgilendiği teknolojiler, React, NextJS, TailwindCSS, Symfony, Laravel. </p>
