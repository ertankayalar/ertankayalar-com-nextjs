...
<a title="b2b"
  href="http://tr.wikipedia.org/wiki/B2B"
  target="_blank"
  rel="noreferrer noopener nofollow">
  B2B
</a> ingilizce "Business to Business" kelimesinin kısaltmasıdır. Firmadan firmaya (şirketler arası) ticarete verilen kısaltmadır. **İnternette, e-biz olarak da bilinen B2B (işletmeden işletmeye), işletmeler ve tüketiciler arasında değil, işletmeler arasında ürün, hizmet veya bilgi alışverişidir (e-ticaret).**
...
Daha fazla ayrıntı için [Neden Dijital Pazarlama](/blog/neden-dijital-pazarlama/) yazımı okuyabilirsiniz.
...
Dijital pazarlama ile ilgili daha ayrıntılı bilgiyi [Dijital Pazarlama](/dijital-pazarlama/) sayfamdan öğrenebilirsiniz.
